				...
				for(int i = LINE; i < goodsarr.length; i++) {
					if(i == 0) {
						WriteTextFile wtf = new WriteTextFile(Goodsarray[i].getInt(), Goodsarray[i].getName(),
								Goodsarray[i].getDescription(), Goodsarray[i].getPrice(), Goodsarray[i].getStock(), false);
						JOptionPane.showMessageDialog(null, "Success");
					} else {
						WriteTextFile wtf = new WriteTextFile(Goodsarray[i].getInt(), Goodsarray[i].getName(),
								Goodsarray[i].getDescription(), Goodsarray[i].getPrice(), Goodsarray[i].getStock(), true);
